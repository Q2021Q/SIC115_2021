                ...
                <div class="col-md-12 top-20 padding-0">
                    <div class="col-md-3">
                        <div class="form-group form-animate-text" style="margin-top:30px !important; width: 100px;">
                            ...
                            <input type="text" class="form-text" id="nivelcuenta" name="nivelcuenta"
                                style="width: 100px;" value="<?php echo $nivelR ?? ""; ?>" readonly>
                        ...
                        <div class="form-group form-animate-text" style="margin-top:30px !important;">
                            <input type="text" class="form-text" id="nombrecuenta" name="nombrecuenta"
                                value="<?php echo $nombrecuentaR ?? ""; ?>" required>
                            <span class="bar"></span>
                            <label>Nombre</label>
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group form-animate-text" style="margin-top:30px !important; width: 300px;">
                            <input onkeyup="generarNivel()" type="text" class="form-text" id="codigocuenta"
                                name="codigocuenta" value="<?php echo $codigocuentaR ?? ""; ?>" required>
                            <span class="bar"></span>
